...
const SPACE_ID = 'kceqoj05xlrn'
const ACCESS_TOKEN = 'c22b65c986a3e34a096c61f5017f8fc6de9772845eef1e43b4cc794d09c8da68'
...
function displayEntries (contentTypes) {
  ...
  return Promise.all(contentTypes.map((contentType) => {
    ...
    .then((entries) => {
      ...
      fs.writeFile('./static/entries.json', json, 'utf8')
